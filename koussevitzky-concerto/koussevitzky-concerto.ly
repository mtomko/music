...
mvtI = \relative {
  ...
  | \time 3/4 R2.
  | \time 4/4 R1
  | r4 b'4\f-2~ 8 ais-1 \once \slurDashed c-3 (b-2)
  | g8-\plus e-4 c-4 (ais-1 \clef bass c) b-2 \once \slurDashed g-0 (e-1) \break
  ...
  | \time 3/4 R2.
  | \time 4/4 R1
  | r4 c'-2\f~ 8 b-1 d-3 c-1 \break

  | b8-3 a-1 g-1 fis-\plus (a-3) g-1 e-4 (c-4)
  | c8-4\> (b-2 ais-1 b-2) c-1 (cis-2 d-1 dis-2) \!
  | e2. \tempo \markup { \small "Alla breve" } r4
  | \clef treble e2.\p \tuplet 3/2 { e8-\tweak extra-offset #'(0 . 0.50)-\plus (fis-\tweak extra-offset #'(0 . 1.1)-1 g-\tweak extra-offset #'(0 . 1.2)-2) }
  | fis4. (e8-1) e2~
  | e4\tenuto e\downbow fis\upbow (g)
  | fis4. (e8) e2-3\2 \break

  | g2.\mf-1\1 \tuplet 3/2 { g8-\tweak extra-offset #'(0 . 1.1)-\plus (a-\tweak extra-offset #'(0 . 1.35)-1 b-\tweak extra-offset #'(0 . 1.2)-2) }
  | a4. (g8) g2~
  | 4 4\downbow a-1\upbow (b-3)
  | a4.-1 (g8-1) g2
  | b4-1\f (d2-3) d8 (cis8-3)
  | cis4 (b-1) \once \override Hairpin.to-barline = ##f \once \override Hairpin.shorten-pair = #'(0 . 3.0) b2~\<
  | 4 e-3\! d-1 (cis-3) \break
  ...
  | g2 fis4-4 (e-1) \!
  | e2. r4
  | \compressMMRests R1*3 \break

  | R1
  | \tempo \markup { \small "a tempo" } c2.\mf-1 \tuplet 3/2 { c8-1 (d-1 e-4) }
  | d4.-1 (c8) c2~
  | c4\< e-4 g-\plus (b-3) \!
  | d4.-3 (c8-1) c2
  ...
  | \once \override Hairpin.shorten-pair = #'(0 . -1.0) d,8-\plus\< (d'-3\flageolet)\! d2-3 (c4-1)
  ...
  | \tuplet 3/2 { cis-\plus ( d-1 dis-3 } \tuplet 3/2 { e-3) g,-\plus (a-1 } \tuplet 3/2 { bes-2) e,-1 (f-2 } \tuplet 3/2 { g-3\flageolet) cis,-1 (d-2) }
  ...
  | \tempo \markup { \small "a tempo" } \tuplet 3/2 { d-2 (cis-1 d-2) } \tuplet 3/2 { fis-2 (eis-1 fis-2) } \tuplet 3/2 { a-3 (gis-2 a-3) } \tuplet 3/2 { c-3 (b-2 c-3) }
  | \tuplet 3/2 { ees-3 (d-2 c-1~ } \tuplet 3/2 { c) bes-2 (a-1) } \tuplet 3/2 { a (g-2 fis-1~ } \tuplet 3/2 { fis) g-1 (a-3) } \break

  | \tempo \markup { \small "accel" }\tuplet 3/2 { g-1 (fis-\plus g-1) } \tuplet 3/2 { b-1 (ais-\plus b-1) } \tuplet 3/2 { d-1 (cis-\plus d-1) } \tuplet 3/2 { f-3 (e-2 d-1) }
  ...
  | bes16-4\p\downbow bes-\tweak extra-offset #'(0.0 . 1.5)\upbow a-2\downbow bes-4\upbow cis-4 cis bis-2 cis-4 e-4 e dis-2 e-4 g-3 g fis-2 g-3
  ...
  | c2-1 (\override Hairpin.shorten-pair = #'(2.0 . 0.0) \once \override Hairpin.to-barline = ##f cis-2~\>
  | cis4\!) cis4 (e-4 d-1)
  ...
  | cis4 a-1\pp\downbow c-3\upbow (b-2)
  | a4-2 (gis-1) fis-4\1 (e-1)
  | dis4-1 (e-2 fis8-1) gis-3 (a-1 b-3) \break
