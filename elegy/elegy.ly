...
solonotes = \relative {
  ...
  | g4.~16\< a-1 (b-4 c-1 d32-4 e-2 f-4 g-\plus) \clef treble aes16-.-1 \! f-.-2 b4-3~ 8 c (d) 
  | g,2.~4 r8 bes,4~\(16.-. bes32-.\) \break
  % line 5
  | bes4\< (a8) d4.\accent\! c4\< (b8) g'4.\accent\!
  | g8\p\accent-\plus a\accent\<-1 b\accent-3 c\accent-\plus d\accent-1 e\accent-3 e4.-3 e,4-1 e8 \! (
  ...
  |  d4.~ d8 %{\clef treble %} b' (a) g16-.-\plus (fis-.-4 f-.-2 \> e-.-1 d-.-4 c-.-1) \clef bass b-.-4 (a-.-1 g-.-4 f-.-1) d-0 g-4\! \break
  % line 11
  | c,4.\downbow~ 8\p f\3 (aes\2) \clef treble c (e g-\plus) \slurDown aes-1 [(\grace { \stemDown bes32 \(aes\) } \stemUp g8-1 \stemNeutral f-\plus]) \slurNeutral
