...
\relative {
  ...
  | d4 r8 r8 d'8 d,
  | d8 d' d, fis, fis' fis,
  | bes8 bes' ees cis d d, \break
  | \mark \default g8 d16 e d8 d b'16 (a) g b
  | a8 d,16 e d8 d c16 (b) a c
  | b'16 d (b g f) e (f) d' (b g f) e (
  | f16) g g b b d d (f32 e f16) d b g \break
  | e'16 g (e c bes) a (bes) g' (e c bes) a (
  ...
  | e'16 bes32 (c d16) g,32 (a bes16) g f' bes,32 ( c d16) g,32 (a bes16) g
  | g'16 g32 (f e16) e32 (d c16) c32 (bes a16) a32 (bes c16) f, c e \break
  ...
  | e16 f g a f g e f g a f g
  | e16 f g f g a d, e f e f g
  | c,16 d e d e f b, c d c d e \break
  | a,16 b c b c d b8 a16 (g) c8~
