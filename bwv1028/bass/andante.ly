...
\relative {
  ...
  | b4.~ b16 fis' (e d cis b) fis'8 fis, \acciaccatura b ais\trill b4 r8 \break
  | r2. r4 r8 r4 d8
  ...
  | a16 bes c8 bes a d16 (c bes a) g (f) bes (a) g (a) f4 r8
  | r2. r4 r8 r4 g8
  ...
  | c16 (d e8) \ottava 1 gis8_\markup {\teeny { \italic { 8\super{"va"} "ad lib" } } }\mordent a4.~ (a8 gis) b8~ b16 gis? (a b) c8
