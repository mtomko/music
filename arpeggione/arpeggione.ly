...
mvtI = \relative {
  ...
  \repeat volta 2 {
    ...
    | d8 (bes) fis (bes) g8\downbow^\markup { \tiny rit. } (bes \tuplet 3/2 { a8-1 g'-3\flageolet f-1) }  \break
    ...
    | \afterGrace bes2. ({ c16 bes a bes) } d8\downbow (c)
    ...
    | ees8\1-1\upbow (ees'-2) \breathe ees4\accent~\> 16 d-1 (c-\plus bes-2\!) a-1 (g-\plus f-4 ees-1) \break
  ...
  | c4 (bes) r8 bes8 (d g)
  | bes8\< aes g2 fis4
  | d'4.\> bes8\upbow (g8) \clef bass d-1 (bes-2 g-4) \break

  % line 6

  | c,16\pp-1 (ees-4 aes-4 c) ees2.~\downbow
  ...
  | \stemDown b16-.-1\3) d'\1-1\p\downbow (e-3 d-1) d,-.\2-\plus\upbow d'\1-1\downbow (e-3 d-1) \stemNeutral g,-.\2-\plus\upbow d'\1-1\downbow (e-3 d-1) b-.\2-3\upbow d-1\downbow (e-3 d-1) \break
  ...
  | \clef treble c8\f\2-2 (c'16) r c4~\accent c16 b-3 (a-1 g-\plus\flageolet) fis\2-3 (e-1 d\2-3\flageolet c-1) \break
  ...
  | g4\< (a8 b e\>) c (b a)\!
  | e4~\downbow (16 fis g a) \afterGrace g4 ({ a16 g fis g} b8. a16) \break
